...
$("#form-create-oaca-close").on('change',".content-image-prev",function(){
...
$(document).ready(function(){
	...
	$("div#bootstrap-wizard-1 div.form-bootstrapWizard ul.bootstrapWizard li#close").addClass('active');
