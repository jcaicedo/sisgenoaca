	...
	$(content_data+" .myinput").each(function(index){
		...
		switch(element){
			...
			if($(this).val()!=''){
				...
				$(content_preview).append('<div class="image-preview-content"><img src="" alt="'+$(this).attr('id')+'" id="loadimage'+countImage+'"></div>');
	...
	$(".content").droppable({
		...
		drop:function(event,ui){
			...
			switch(opt){
				...
				$("#imagep-"+count).after("<input type='hidden' name='data["+count+"][pattern]' value='"+$(this).data('pattern')+"'>");
