		...
		if (type != 'contenedor') {
			switch (type) {
				case 'title':
					...
					$(".remove-div-" + count).find('input').attr({
						"data-element": "title",
						"id": "title-" + count,
						"name": "data[" + count + "][content]"
					}).addClass("myinput");
					$(".remove-div-" + count).find('button').attr({
						"data-parent": "remove-div-" + count
					}).addClass('remove-div');
				...
				case 'textarea':
					...
					$(".remove-div-" + count).find('.edit-textarea').attr({
						"data-element": "textarea",
						'data-content': 'content-textarea' + count,
						'id': 'textarea' + count,
						"name": "textarea"
					}).addClass("myinput");
				...
				case 'uploadimage':
					...
					$(".remove-div-" + count).find('img').attr({
						"id": "imagecontent" + count
					});
					$(".remove-div-" + count).find('input').attr({
						"data-element": "image",
						"data-position": count,
						"data-image-content": "#imagecontent" + count,
						'value': 'image-' + count,
						"name": "image" + count,
						"id": 'imagep-' + count
					}).addClass("myinput");
				...
				case 'uploadhotpotatoes':
					...
					$(".remove-div-" + count).find('input').attr({
						"data-element": "filehtml",
						"data-position": count,
						'value': 'filehtml-' + count,
						"name": "filehtml" + count,
						"id": 'filehtmlp-' + count
					}).addClass("myinput");
					$(".remove-div-" + count).find('button').attr({
