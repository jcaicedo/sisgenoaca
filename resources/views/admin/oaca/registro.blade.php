...
<br> <br>
        ...
        <div class="box box-body" id="ciclo_vida">
        	...
        	<br>
        	<div class="form-group">
        		<label for="form_registro" class="col-sm-2 control-label"> Versión  <span>*</span> </label>
        	...
        	<!--./version -->
        	          <div class="form-group">
            <label for="form_registro" class="col-sm-2 control-label">Estado</label>
            <div class="col-sm-10">
...
<div class="col-sm-12">
	   <div class="box">
          	<div class="box-header with-border">
          		<h3 class="box-title">Colaboradores <span>*</span> </h3>
          		<div class="box-tools pull-right">
          			<button class="btn btn-box-tool" id="btn-add-contri">
			...
			<div class="section_contri">
				...
				<div class="form-group">
						...
						<label for="form_registro" class="col-sm-2 control-label"> Tipo de Contribución </label>
						<div class="col-sm-10">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<input type="text" name="contri_last_name" id="" class="form-control" placeholder="Ingrese Apellido">
					</div>
					 {{--/.col-sm-3--}}
                    <div class="col-sm-3">
